...
Wir möchten die Python 3.14-Umgebung ausführen und den Debugger bei einem
fehlgeschlagenen Test starten mit ``tox -e py314 -- --pdb --no-cov``. Das
...
mit diesem einen Testfehler erneut ausführen: ``tox -e py314 -- --lf --tb=no
--no-cov``.
